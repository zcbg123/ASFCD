...
from network.ASFCD import FMENet
...
if __name__ == '__main__':
    ...
    parser.add_argument('--epoch', type=int, default=80, help='50') 
    ...
    if opt.data_name == 'LEVIR':
        ...
        opt.train_root = 'dataset/CLCD-256/train/'
        opt.val_root = 'dataset/CLCD-256/val/'
